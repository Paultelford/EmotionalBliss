...
Partial Class editor2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If Request.QueryString("p") <> "" And Request.QueryString("l") <> "" And Request.QueryString("pg") <> "" Then
                ...
                txtEditor.Text = getDBResouceString(Request.QueryString("p"), Request.QueryString("l"), getSQLPagename(Request.QueryString("pg")), False)
    ...
    Protected Sub drpPageType_selectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
        ...
        txtEditor.Text = "" 'Clear editor window
    ...
    Protected Sub btnSubmit_click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If Len(txtEditor.Text) <= 8000 Then
            ...
            With oCmd
                ...
                .Parameters("@string").Value = txtEditor.Text
            End With
            If Not panControls.Visible Then oCmd.Parameters("@page").Value = getSQLPagename(drpIndividualPage.SelectedValue)
            If LCase(Request.QueryString("p")) = "pagetitle" Or LCase(Request.QueryString("p")) = "metadescription" Or LCase(Request.QueryString("p")) = "metakeywords" Then oCmd.Parameters("@string").Value = formatData(txtEditor.Text)
            Try
