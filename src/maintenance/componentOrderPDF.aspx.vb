...
Partial Class maintenance_componentOrderPDFWTF
    ...
    Protected Sub bindLabels()
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0)("instructions")) Then lblInstructions.Text = Replace(ds.Tables(0).Rows(0)("instructions"), Chr(13), "<br>")
