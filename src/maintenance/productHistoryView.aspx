<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="productHistoryView.aspx.vb" Inherits="maintenance_productHistoryView" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <ContentTemplate>
            <asp:GridView ID="gvHistory" runat="server" DataSourceID="SqlHistory" AutoGenerateColumns="false" CellPadding="4" CellSpacing="0" GridLines="vertical" ShowFooter="true" OnDataBound="gvHistory_dataBound" EmptyDataText="No data found for sleected date range.">
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Action" DataField="prodAction" />
    ...
    <asp:SqlDataSource ID="SqlHistory" runat="server" SelectCommand="procProductHistoryByProductIDSelect" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:connectionString %>">
        <SelectParameters>
