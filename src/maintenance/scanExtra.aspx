<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="scanExtra.aspx.vb" Inherits="affiliates_scanExtra" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <atlas:UpdatePanel ID="update1" runat="server">
        <ContentTemplate>
            ...
            <asp:HyperLink ID="lnkBack" runat="Server" Text="Back to Scan page" NavigateUrl="scan.aspx" Visible="false"></asp:HyperLink>
            <br /><br /><br />
