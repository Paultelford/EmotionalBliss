...
Partial Class maintenance_warehouseHistoryView
    ...
    Protected Const _actionPos As Integer = 2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not Membership.GetUser Is Nothing Then
            ...
            If Not Page.IsPostBack Then
                ...
                Dim oCmd As New SqlCommand("procWarehouseProductByIDSelect", oConn)
                Dim da As New SqlDataAdapter
                Dim ds As New DataSet
                With oCmd
                    .CommandType = CommandType.StoredProcedure
                    .Parameters.Add(New SqlParameter("@pid", SqlDbType.Int))
                    .Parameters("@pid").Value = Request.QueryString("id")
                End With
                Try
                    ...
                    If ds.Tables(0).Rows.Count > 0 Then
                        lblProduct.Text = ds.Tables(0).Rows(0)("warehouseProductName")
                    Else
    ...
    Protected Sub gvHistory_dataBound(ByVal sender As Object, ByVal e As EventArgs)
        ...
        For Each Row As GridViewRow In gvHistory.Rows
            If Row.RowType = DataControlRowType.DataRow Then
                ...
                Select Case lblActionID.Text
                    Case "4"
                        'Order (From EB Live)
                        Row.Cells(_actionPos).Text = "Order " & lblOrderID.Text & " (From EB Live)"
                End Select
