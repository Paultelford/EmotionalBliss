<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="warehouseListEdit.aspx.vb" Inherits="maintenance_warehouseListEdit" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:DetailsView ID="dvDetails" runat="server" GridLines="none" DataSourceID="SqlDetails" AutoGenerateRows="false">
        ...
        <Fields>
            ...
            <asp:BoundField HeaderText="Stock:" DataField="stock" NullDisplayText="0" />
    ...
    <asp:SqlDataSource ID="SqlDetails" runat="server" SelectCommand="procWarehouseStockByProductIDSelect" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:connectionString %>">
        <SelectParameters>
