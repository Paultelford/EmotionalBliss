...
Partial Class maintenance_distributorProducts
    ...
    Protected Sub addOnSale(ByVal tbl As String, ByVal tblID As Integer, ByVal name As String)
        ...
        Else
            ...
            Dim oCmd As New SqlCommand("procAffiliateProductBuyingInsert2", oConn)
            ...
            With oCmd
                ...
                .Parameters("@affProductName").Value = Server.HtmlDecode(name)
