<%@ Page Language="VB" AutoEventWireup="false" CodeFile="componentOrderPDF.aspx.vb" Inherits="maintenance_componentOrderPDFWTF" %>
...
<body>
    ...
    <asp:Panel ID="panMain" runat="server">
        ...
        <table border="0" width="792">
            <tr>
                <td align="center">
                    <h1 style="color:black;"><b>Purchase Order</b></h1>
                </td>
            </tr>
        </table>    
        <br />    
