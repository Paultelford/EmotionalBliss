<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" Trace="false" AutoEventWireup="false" CodeFile="distributorProducts.aspx.vb" Inherits="maintenance_distributorProducts" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <tr>
                    <td width="500" valign="top">
                        <table border="0" width="100%">
                            <tr>
                                <td height="40">
                                    <b>Current Items Associated with Distributor:</b>        
                                </td>
                                <td align="right">
                        ...
                        <asp:Panel ID="pan1" runat="server" BorderWidth="1" BorderColor="gray" height="464" ScrollBars="vertical" Width="99%">
                                <asp:GridView ID="gvOnSale" runat="Server" DataSourceID="SqlOnSale" AutoGenerateColumns="false" GridLines="none" ShowHeader="false" SkinID="GridViewRedBG" OnSelectedIndexChanged="gvOnSale_selectedIndexChanged" Width="94%" DataKeyNames="affProductBuyingID" OnDataBinding="gvOnSale_dataBinding" OnRowDeleted="gvOnSale_rowDeleted">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="affProductName" HtmlEncode="true" NullDisplayText="Not Set" />
                                        <asp:BoundField DataField="warehouseProductCode" HtmlEncode="true" NullDisplayText="Not Set" />
                    ...
                    <td width="300" valign="top">
                        ...
                        <asp:Panel ID="pan2" runat="server" BorderWidth="1" BorderColor="gray" Height="200" ScrollBars="vertical" Width="99%">
                            <asp:GridView ID="gvComp" runat="server" DataSourceID="SqlComp" AutoGenerateColumns="false" GridLines="none" ShowHeader="false" Width="94%" SkinID="GridViewRedBG" OnSelectedIndexChanged="gvComp_selectedIndexChanged" DataKeyNames="componentID">
                                <HeaderStyle Font-Bold="true" />
                                <Columns>
                        ...
                        <asp:Panel ID="pan4" runat="server" BorderWidth="1" BorderColor="gray" Height="200" ScrollBars="vertical" Width="99%">
                            <asp:GridView ID="gvBProd" runat="server" DataSourceID="SqlBProd" AutoGenerateColumns="false" ShowHeader="false" GridLines="none" Width="94%" SkinID="GridViewRedBG" OnSelectedIndexChanged="gvBProd_seletcedIndexChanged" DataKeyNames="warehouseProductID">
                                <Columns>
    ...
    <asp:SqlDataSource ID="SqlAff" runat="Server" SelectCommand="procAffiliatesDistributorsSelect" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:connectionString %>">
        <SelectParameters>
        </SelectParameters>
    </asp:SqlDataSource>
