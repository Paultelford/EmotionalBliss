<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="distPayment.aspx.vb" Inherits="maintenance_distPayment" title="Untitled Page" %>
        ...
        <ProgressTemplate>
            ...
            <table border="0">
                <tr>
                    ...
                    <td>
                        <asp:RadioButton ID="chkCC" runat="server" Text="Credit Card" OnCheckedChanged="chkCC_checkedChanged" AutoPostBack="true" GroupName="type" /><br />
                        <asp:RadioButton ID="chkAccount" runat="server" Text="Account Order" OnCheckedChanged="chkAccount_checkedChanged" AutoPostBack="true" Visible="true" GroupName="type" /><br />
                    </td>
                </tr>
            </table>
            <br /><br />
                    ...
                    <td id="tdCardDetails" runat="server" visible="false" width="340">
                        ...
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCV2" runat="server" MaxLength="3" Width="26"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
