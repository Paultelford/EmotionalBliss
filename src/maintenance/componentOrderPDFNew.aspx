<%@ Page Language="VB" AutoEventWireup="false" CodeFile="componentOrderPDFNew.aspx.vb" Inherits="maintenance_componentOrderPDFNew" %>
...
<body>
    ...
    <asp:Panel ID="panMain" runat="server">
        <img src="../images/peartreePOlogo.jpg" width="650" height="99" /><br />
        <span id="orderHTML">
        <asp:Table runat="server" ID="tblAddresses" Width="650" BorderWidth="0">
            <asp:TableRow>
        ...
        <table border="0" width="650">
            <tr>
                <td align="center">
                    <h2 style="color:black;"><b>Purchase Order</b></h2>
                </td>
            </tr>
        </table>    
        <br />    
        <asp:Table id="tblPO" runat="server" BorderWidth="0" Width="650" CellPadding="0" CellSpacing="0">
            <asp:TableRow>
        ...
        <asp:Table ID="tblItems" runat="server" Width="650" BorderWidth="0" CellSpacing="0" GridLines="Both">
            <asp:TableRow>
