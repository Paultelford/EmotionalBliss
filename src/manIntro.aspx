<%@ Page Language="VB" MasterPageFile="~/MasterPageSite.master" AutoEventWireup="false" CodeFile="manIntro.aspx.vb" Inherits="manIntro" title="Untitled Page" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%"  id="tblHeader" runat="server">
        <tr>
            <td valign="top" width="130" id="tdLeftMenu" runat="server">
                <!-- Left Menu -->
                <menu:SexologistsMenu id="sex1" runat="server" menuName="man"></menu:SexologistsMenu>
            </td>
