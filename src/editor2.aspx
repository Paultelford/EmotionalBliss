<%@ Page Title="" Language="VB" MasterPageFile="~/maffs.master" AutoEventWireup="false" ValidateRequest="false" CodeFile="editor2.aspx.vb" Inherits="editor2" %>
            ...
            <table border="0" width="930">
                ...
                <tr>
                    <td align="left" colspan="2">
                        ...
                        <asp:TextBox ID="txtEditor" runat="server" Height="300" Width="100%" TextMode="MultiLine"></asp:TextBox>
                        <table border="0" width="930">
                            <tr>
                                <td align="right">
