<%@ Page Language="VB" AutoEventWireup="false" CodeFile="statementInvoice.aspx.vb" Inherits="affiliates_statementInvoice" %>
                ...
                <td>
                    <asp:FormView ID="fvAffiliate" runat="server" DataSourceID="sqlAffiliate" GridLines="none" OnDataBound="fvAffiliate_dataBound" Width="100%">
                        <ItemTemplate>
                            ...
                            <hr class="blueline" />
                            <br /><br />
                            <asp:Label id="lblOrderIDText" runat="server" Font-Size="medium" Text="Emotional Bliss Invoice No: "></asp:Label>
                            ...
                            <asp:Label ID="lblVATNo" runat="server" Font-Size="medium" Text='<%# Eval("affVAT") %>'></asp:Label><br />
                            ...
                            <td>
                                <asp:GridView ID="gvOrderItems" runat="server" GridLines="none" DataKeyNames="orderItemID" DataSourceID="sqlOrderItems" AutoGenerateColumns="false" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField ItemStyle-Width="40" ReadOnly="true" />
                                        <asp:BoundField HeaderText="Unit Price" DataField="price" ControlStyle-Width="60" HtmlEncode="false" DataFormatString="{0:n2}" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="right" ItemStyle-Width="80" />
                                        <asp:BoundField ItemStyle-Width="40" ReadOnly="true" />
                                        <asp:BoundField HeaderText="Total" DataField="rowTotal" DataFormatString="{0:n2}" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="right" />
                                    </Columns>
                                </asp:GridView>    
                            </td>
                        </tr>
                        ...
                        <ItemTemplate>
                            <table width="700">
                                <tr>
                                    ...
                                    <td align="right">
                                        <asp:Label ID="lblGoodsExc" runat="server" Font-Size="medium" Text='<%# Eval("currencySign") & Eval("goods") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td align="right">
                                        <asp:Label ID="lblShippingExc" runat="server" Font-Size="medium" Text='<%# Eval("currencySign") & Eval("shipping") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td align="right">
                                        <asp:Label ID="lblVat" runat="server" Font-Size="medium" Text='<%# Eval("currencySign") & calcVat(Eval("goodsVat"),Eval("shipping"),Eval("shippingTotal")) %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td align="right" width="120">
                                        <asp:Label ID="lblTotal" runat="server" Font-Size="medium" Text='<%# Eval("currencySign") & formatNumber(Eval("orderTotal"),2) %>'></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
