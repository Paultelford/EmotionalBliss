<%@ Page Language="VB" MasterPageFile="~/maffs.master" AutoEventWireup="false" CodeFile="salesLedgerLog.aspx.vb" Inherits="affiliates_salesLedgerLog" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                        ...
                        <td align="left">
                            ...
                            <asp:GridView ID="gvSalesLedger" runat="server" ShowFooter="true" DataKeyNames="day" DataSourceID="sqlSalesLedger" AutoGenerateColumns="false" OnSelectedIndexChanged="gvSalesLedger_selectedIndexChanged" SkinID="GridView" OnDataBound="gvSalesLedger_databound" EmptyDataText="No orders found." Width="100%">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField ItemStyle-Width="20" />
                                    <asp:BoundField HeaderText="Cheque/Paypal" DataField="cheque" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="right" />
                                    <asp:BoundField ItemStyle-Width="20" />
                                    ...
                                    <asp:BoundField ItemStyle-Width="20" />
                                    <asp:TemplateField HeaderText="Shipping Total" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="right">
                                        <ItemTemplate>
                                            <asp:Label ID="lblShippingTotal" runat="server" Text="0.00"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField ItemStyle-Width="20" />
                                    <asp:TemplateField HeaderText="Vat Total" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="right">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVatTotal" runat="server" Text='<%# getVatForRefunds(Eval("vat"),Eval("ledgerActionID")) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField ItemStyle-Width="20" />
                                    ...
                                    <asp:BoundField ItemStyle-Width="20" Visible="false" />
                                    <asp:TemplateField HeaderText="Total (Inc Vat)" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="right">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalIncVat" runat="Server" Text='<%# formatNumber(Eval("balance") +  Eval("affiliatecc") + Eval("affiliateaccount") + Eval("cheque"),2) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
            ...
            <asp:Panel ID="panDetails" runat="server" Visible="false">
                ...
                <asp:GridView ID="gvSalesLedgerDay" runat="server" datasourceid="sqlSalesLedgerDay" AutoGenerateColumns="false" SkinID="GridView" ShowFooter="true" OnDataBound="gvSalesLedgerDay_dataBound">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Goods & Shipping" DataField="balance" />
                        <asp:BoundField ItemStyle-Width="40" />
    ...
    <asp:SqlDataSource ID="sqlSalesLedger" runat="server" SelectCommand="procSalesLedgerByDateSelect" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:connectionString %>">
        <SelectParameters>
