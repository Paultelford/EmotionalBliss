<%@ Page Language="VB" MasterPageFile="~/maffs.master" AutoEventWireup="false" CodeFile="salesLedgerMonthly.aspx.vb" Inherits="affiliates_salesLedgerMonthly" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                                ...
                                <tr>
                                    ...
                                    <td valign="bottom">
                                        <table border="0">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblTypeText" runat="server" Text="Type:"></asp:Label><br />
                                                    Country:
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td valign="bottom">
                                        ...
                                        <asp:DropDownList ID="drpCountry" runat="server" AutoPostBack="true" DataTextField="countryName" DataValueField="countryCode" DataSourceID="sqlCountry" AppendDataBoundItems="false" OnDataBound="drpCountry_dataBound">
                                        </asp:DropDownList>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:SqlDataSource ID="sqlCountry" runat="server" SelectCommand="procCountryMaintenanceSelect" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:connectionString %>">
    </asp:SqlDataSource>
