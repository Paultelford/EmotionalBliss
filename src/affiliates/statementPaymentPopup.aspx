<%@ Page Language="VB" AutoEventWireup="false" CodeFile="statementPaymentPopup.aspx.vb" Inherits="affiliates_statementPaymentPopup" %>
                        ...
                        <ItemTemplate>
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblCurrencySign1" runat="server" Text='<%# Eval("currencySign") %>'></asp:Label>
                                        <asp:Label ID="lblAmount" runat="server" Text='<%# formatNumber(cDec(Eval("statementCredit"))-cDec(Eval("statementDebit")),2) %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
