<%@ Page Language="VB" MasterPageFile="~/MasterPageSite.master" AutoEventWireup="false" CodeFile="salesLedgerLogOld.aspx.vb" Inherits="affiliates_salesLedgerLogOld" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <asp:Panel ID="panLog" runat="server">
                ...
                <asp:GridView ID="gvSalesLedger" runat="server" ShowFooter="true" DataKeyNames="day" DataSourceID="sqlSalesLedger" AutoGenerateColumns="false" OnSelectedIndexChanged="gvSalesLedger_selectedIndexChanged" SkinID="GridView" OnDataBound="gvSalesLedger_databound" EmptyDataText="No orders found.">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField ItemStyle-Width="40" />
                        <asp:BoundField HeaderText="Affiliate" DataField="affiliate" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="right" />
                        <asp:BoundField ItemStyle-Width="40" />
                        <asp:BoundField HeaderText="Vat" DataField="vat" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="right" />
                        <asp:BoundField ItemStyle-Width="40" />
                        <asp:TemplateField HeaderText="Total (Inc Vat)" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="right">
                            <ItemTemplate>
                                <asp:Label ID="lblTotalIncVat" runat="Server" Text='<%# formatNumber(Eval("balance") + Eval("vat") + Eval("affiliate") + Eval("cheque"),2) %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
    ...
    <asp:SqlDataSource ID="sqlSalesLedger" runat="server" SelectCommand="procSalesLedgerByDateSelectOld" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:connectionString %>">
        <SelectParameters>
