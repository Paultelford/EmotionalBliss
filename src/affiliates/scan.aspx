<%@ Page Language="VB" MasterPageFile="~/maffs.master" AutoEventWireup="false" CodeFile="scan.aspx.vb" Inherits="affiliates_scan" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <asp:GridView ID="gvOrderItems" runat="server" DataSourceID="sqlOrderItems" DataKeyNames="itemID" AutoGenerateColumns="false" GridLines="none" ShowHeader="true" OnDataBound="gvOrderItems_dataBound">
                                <Columns>
                                    <asp:BoundField DataField="itemName" HeaderText="Items In Order" />
            ...
            <asp:Panel ID="panTrackerEmail" runat="server" Visible="false">
                <table border="0">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="drpCourier" runat="server" DataSourceID="sqlCourier" AutoPostBack="true" DataTextField="courier" DataValueField="courierID" OnSelectedIndexChanged="drpCourier_selectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="drpType" runat="server" OnSelectedIndexChanged="drpType_selectedIndexChanged" AutoPostBack="true">
                                <asp:ListItem Text="Standard APC" Value="standardapc"></asp:ListItem>
                                <asp:ListItem Text="Standard DHL" Value="standarddhl"></asp:ListItem>
                                <asp:ListItem Text="Standard UPS" Value="standardups"></asp:ListItem>
                                <asp:ListItem Text="Standard TNT" Value="standardtnt"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTracker" runat="server" ValidationGroup="tracker" AutoPostBack="true" OnTextChanged="btnTrackerSubmit_click"></asp:TextBox> <asp:Button ID="btnTrackerSubmit" runat="server" ValidationGroup="tracker" Visible="false" Text="Submit" />
                        </td>
                        <td>
                            Qty:&nbsp;
    ...
    <asp:SqlDataSource ID="sqlRecentOrders" runat="server" SelectCommand="procShopOrderByCountryCodeSelect20" SelectCommandType="StoredProcedure" ConnectionString='<%$ ConnectionStrings:connectionString %>'>
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="sqlOrderItems" runat="server" SelectCommand="procShopOrderItemByIDSelect3" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:connectionString %>">
        <SelectParameters>
            <asp:ControlParameter ControlID="hidOrderID" PropertyName="value" Name="ID" Type="int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sqlCourier" runat="server" SelectCommand="procCourierSelect" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:connectionString %>">
        <SelectParameters>
            <asp:SessionParameter SessionField="EBAffEBDistributorCountryCode" Name="countryCode" Type="String" Size="5" />
        </SelectParameters>
    </asp:SqlDataSource>
