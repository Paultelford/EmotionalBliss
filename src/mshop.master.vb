...
Partial Class mshop
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Init
        If Request.QueryString("ebdebug") = "true" Then panLeftTopMenu.Visible = True
        ...
        If Request.QueryString("shop") = "" Then
            Session("EBShopCountry") = Session("EBShopCountry")
            Profile.EBShop = Session("EBShopCountry")
            Profile.EBCountryName = getCountryName(Session("EBShopCountry"))
        End If
        ...
        'If InStr(Request.ServerVariables("SCRIPT_NAME"), "product.aspx") > 0 Then panLeftTopMenu.Visible = True
        'If InStr(Request.ServerVariables("SCRIPT_NAME"), "dept.aspx") > 0 Then panLeftTopMenu.Visible = True
        'If InStr(Request.ServerVariables("SCRIPT_NAME"), "shopIntro.aspx") > 0 Then panLeftTopMenu.Visible = True
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        For Each dli As DataListItem In dlMenu.Items
            ...
            If LCase(lnkMenu.Text) = "tell a friend" Then
                ...
                lnkMenu.NavigateUrl = Request.ServerVariables("PATH_INFO")
                If Request.ServerVariables("QUERY_STRING") <> "" Then lnkMenu.NavigateUrl = lnkMenu.NavigateUrl & "?" & Request.ServerVariables("QUERY_STRING")
                lnkMenu.NavigateUrl = lnkMenu.NavigateUrl & "#"
                'lnkMenu.Attributes.Add("onclick", "return false;")
                'lnkMenu.NavigateUrl = "#"
    ...
    'Subs
    Public Sub updateBasket()
        lblTopItems.Text = Profile.EBCart.Items.Count.ToString()
        lblTopCurrency.Text = getCurrencyCode()
    ...
    End Sub
    Public Sub AddToHeader(ByVal h As String)
        Dim _keyWords As New System.Web.UI.HtmlControls.HtmlMeta
        _keyWords.Attributes.Add("property", "og:image")
        _keyWords.Content = h
