...
Partial Class m_shop
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If i = 1 Or i = 2 Then imgHeaderRnds.ImageUrl = Replace("/images/" & imgName, "?", "1")
        If i = 3 Or i = 4 Then imgHeaderRnds.ImageUrl = Replace("/images/" & imgName, "?", "2")
        If i = 5 Or i = 6 Then imgHeaderRnds.ImageUrl = Replace("/images/" & imgName, "?", "3")
        r = Nothing
    ...
    Protected Sub loadDbResources()
        ...
        Try
            ...
            Next
        Catch ex As Exception
            siteInclude.addError("m_shop.master.vb", "loadDbResources(); " & ex.ToString())
        Finally
            dt.Dispose()
        End Try
    End Sub
