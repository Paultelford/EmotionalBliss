...
Partial Class applicationWholesale
    Inherits BasePage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            reqStores.ErrorMessage = getDBResourceString("text_Required")
    ...
    Protected Sub btnAgree_click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If Page.IsValid Then
            ...
            Else
                ...
                Dim oCmd As New SqlCommand("procAffiliateWholesaleInsert", oConn)
                With oCmd
                    ...
                    .Parameters.Add(New SqlParameter("@wholesaleStores", SqlDbType.VarChar, 50))
                ...
                Try
                    ...
                    siteInclude.debug("Insert executed, affID=" & affID)
                    If affID > 0 Then result = True
                    If result Then
                        storeCheckboxItems(affID)
                        'Add to affLog
                        siteInclude.addToAffiliateLog(affID, "Wholesale application form submitted.", True, "", "System")
                        'Send email to PT
                        Try
                    ...
                    End If
                Catch ex As Exception
                    siteInclude.addError("applicationWholesale.aspx.vb", "btnAgree_click(); " & ex.ToString)
        ...
        Else
            lblErrorPassword.Text = "Page validation failed. Please make sure you complete the form before pressing Submit" & txtPassword.Text
            lblErrorPassword.Visible = True
        End If
    End Sub
    ...
    Protected Sub addItem(ByVal txt As String, ByVal affID As Integer)
        ...
        Catch ex As Exception
            siteInclude.addError("applicationWholesale.aspx.vb", "addItem(affID=" & affID & ", txt=" & txt & "); " & ex.ToString)
        Finally
        End Try
    End Sub
End Class
