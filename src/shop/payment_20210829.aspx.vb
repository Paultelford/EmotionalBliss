            ...
            If orderID <> 0 Then 'If orderID contains a 0 then there has been an error 
                ...
                Else
                    If Type <> "cheque" Then
                        ...
                        End If
                        Session("EBTmpUniqueID") = uqID
                        siteInclude.addError("payment.aspx.vb", "EBTmpOrderDeferred=" & Session("EBTmpOrderDeferred"))
                        If bVoucherOrder Then
                            ...
                            Else
                                ...
                                siteInclude.addError("payment.aspx.vb", "**DELETED voucher line 735" & uqID)
                                'deleteOrder(uqID)
                            End If
                        Else
                            ...
                            If Session("EBTmpOrderDeferred") = "ok" Then
                                ...
                                sendConfirmationEmail(orderID, uqID, "confirmation")
                                siteInclude.addError("payment.aspx.vb", "**A" & uqID)
                                Response.Redirect("receipt.aspx")
                            ElseIf Session("EBTmpOrderDeferred") = "3dauth" Then
                                ...
                                'storeCustomerDetails()
                                siteInclude.addError("payment.aspx.vb", "**B" & uqID)
                                setOrderAs3DAuth(uqID)
                            Else
                                'Payment failed, delete the order
                                siteInclude.addError("payment.aspx.vb", "**DELETED " & uqID)
            ...
            Else
                ...
                Else
                    ...
                    If strStatus = "OK" Then
                        ...
                        siteInclude.AddToOrderLog(id, strDBStatus & "; txID=" & strVendorTxCode, "Payment System", True)
                        bErrorLogged = True
