...
<asp:Content id="ContntMenu" ContentPlaceHolderID="ContentLeftMenu" runat="server">
    ...
    <table border="0" runat="server" id="tblAddToBasket">
        <tr>
            <td align="left">
                <asp:Label ID="lblCurrencySign" runat="server" Font-Bold="true" Font-Size="Large"></asp:Label><asp:Label ID="lblPrice" runat="server" Font-Bold="true" Font-Size="Large"></asp:Label> (inc vat)
            </td>
        </tr>
        <tr>
            <td align="left">
        ...
        <tr>
            <td align="center">
                <asp:ImageButton ID="btnViewProducts" Visible="false" runat="server" OnClick="btnViewProducts_click" ImageUrl="<%$ Resources:imgViewProducts%>" />                                                        
            </td>
        </tr>
                                                ...
                                                <table border="0" width="100%" valign="top">
                                                    <tr>
                                                        <td valign="top" width="100%" colspan="2">
                                                            <asp:Label ID="lblProdName" runat="server" CssClass="lightbluehead"></asp:Label>
                                                            <br /><br />
                                    ...
                                    <asp:Panel ID="panProductDescription4" runat="server" Visible="false">
                                        <div id="productinfocontainer">
                                            <div id="productinfopic">
                                                <asp:Image ID="imgProductReview" runat="server" Width="270" Height="230" />
            ...
            <table width="100%">
                <tr>
                    <td id="tdButton1" runat="Server" align="center">
                        <asp:ImageButton ID="lnkSubMenuSensations" runat="server" ImageUrl="/design/shop/images//sensations-graph-btn.jpg" OnClick="lnkSubMenuSensations_click" />        
                    </td>
