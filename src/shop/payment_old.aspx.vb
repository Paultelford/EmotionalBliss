...
Partial Class shop_payment
                ...
                Else
                    If bLiveAuth Then
                        ...
                        If CBool(Session("EBTmpOrderPaid")) Then
                            ...
                            si.AddToOrderLog(uqID, "Voucher " & _voucherNumber & " despatched via email", "System", True, "Email")
    ...
    Protected Sub addOrderToVoucher(ByVal orderID As Integer, ByVal voucherNumber As String)
        ...
        Catch ex As Exception
            Dim si As New siteInclude
            si.addError("payment.aspx.vb", "addOrderToVoucher(" & orderID & "," & voucherNumber & ")::" & ex.ToString)
        Finally
            oCmd.Dispose()
            oConn.Dispose()
        End Try
    ...
    Protected Sub setEmailBody(ByVal newOrderID As String, ByVal orderID As Integer, ByRef toAdd As String, ByRef ccAdd As String, ByRef subject As String)
        ...
        emailBody = emailBody & "You can monitor the progress of your order by entering your surname " & Chr(13)
        emailBody = emailBody & "and Order ID to track your order online:" & Chr(13) & "<a href='http://www.emotionalbliss.co.uk/traceOrder.aspx'>http://www.emotionalbliss.co.uk/traceOrder.aspx</a>" & Chr(13) & Chr(13)
        ...
        If lcase(session("EBShopCountry")) <> "nl" And lcase(session("EBShopCountry")) <> "be" Then emailBody = emailBody & "All cheque orders will be despatched on cleared funds." & Chr(13) & Chr(13)
        'emailBody = emailBody & "(UK)0870 041 00 22" & Chr(13) & "(Europe) 0044 870 041 0022" & Chr(13) & Chr(13)
        emailBody = emailBody & "ORDER ID       : " & newOrderID & ucase(lcase(session("EBShopCountry"))) & Chr(13)
        ...
        emailBody = emailBody & "Order Total: " & Profile.EBCart.CurrencySign & FormatNumber(CDec(Profile.EBCart.TotalInc), 2) & Chr(13) & Chr(13)
        If lcase(session("EBShopCountry")) = "nl" Or lcase(session("EBShopCountry")) = "be" Then
            emailBody = emailBody & "If you require any further information please call our help desk on 0044 (0)870 041 00 22" & Chr(13) & Chr(13)
        Else
    ...
    Protected Function commitOrder(ByVal customerID As Integer, ByVal orderPrefix As String, ByVal orderType As String, ByRef uid As Integer) As Integer
        ...
        With oCmd
            ...
            .Parameters("@goodsVat").Value = Profile.EBCart.GoodsVat
