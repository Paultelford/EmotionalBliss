...
Partial Class shop_receipt
    ...
    Protected Sub gvBasket_Load(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            lblVatCost.Text = currencySign & FormatNumber(CStr(If(Profile.EBCart.CouponVat > 0, Profile.EBCart.CouponVat, Profile.EBCart.GoodsVat) + Profile.EBCart.ShippingVat), 2)
            ...
            If VoucherDiscount <> 0 Then
                ...
                If Profile.EBCart.VoucherIsCoupon Then
                    ...
                    If (Profile.EBCart.VoucherIsPercent) Then
                        lblCouponDiscount.Text = VoucherDiscount & "%" & "<br>"
                    Else
                ...
                Else
                    ...
                    If (Profile.EBCart.VoucherIsPercent) Then
                        lblVoucherDiscount.Text = VoucherDiscount & "%" & "<br>"
                    Else
                        lblVoucherDiscount.Text = currencySign & VoucherDiscount & "<br>"
                    End If
                End If
