...
Partial Class shop_basket
    ...
    Protected Function getCurrencySign() As String
        ...
        Catch ex As Exception
            Try
                Dim si As New siteInclude
                si.addError("shop/basket.aspx", "getCurrencySign(Session('EBlanguage')=" & Session("EBLanguage") & ");" & ex.ToString)
                si = Nothing
    ...
    Protected Sub testForVoucher()
        ...
        For Each row As GridViewRow In gvBasket.Rows
            If row.RowType = DataControlRowType.DataRow Then
                ...
                If InStr(LCase(lblPearTreeProductCode.Text), "v_") Or InStr(LCase(lblPearTreeProductCode.Text), "vc") Then
